...
import { noteRestoreBulkSchema } from "@/lib/validators"
...
export async function POST(req: Request) {
  try {
    ...
    const parsed = noteRestoreBulkSchema.safeParse(body)
    ...
    return prismaErrorResponse(err) ?? jsonException(err, { route: "POST /api/notes/trash/restore" })
  }
}
